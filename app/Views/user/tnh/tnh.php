...
<head>
    ...
    <?= $this->include('user/tnh/components/links'); ?>
</head>

<body class="font-nunito">
    <div class="d-flex">
        <?= $this->include('user/tnh/components/sidebar'); ?>
        <section class="vh-100 w-100 scrollable-y">
            <?= $this->include('user/tnh/components/topbar'); ?>
                ...
                <div class="container-lg px-4">
                    ...
                    <div id="breadcrumb" class="mb-3">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">TNH</li>
    ...
    <?= $this->include('user/tnh/components/scripts'); ?>
