...
<head>
    ...
    <?= $this->include('user/kdp/components/links'); ?>
</head>

<body class="font-nunito">
    <div class="d-flex">
        <?= $this->include('user/kdp/components/sidebar'); ?>
        <section class="vh-100 w-100 scrollable-y">
            <?= $this->include('user/kdp/components/topbar'); ?>
                ...
                <div class="container-lg px-4">
                    ...
                    <div id="breadcrumb" class="mb-3">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">KDP</li>
    ...
    <?= $this->include('user/kdp/components/scripts'); ?>
