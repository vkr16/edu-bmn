                    ...
                    <div class="card rounded-1 bg-light border-0">
                        ...
                        <div class="card-body table-responsive">
                            <table id="tabel-atl" class="table">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($atldata as $key => $atl) {
                                    ?>
                                        <tr>
                                            <td><?= $key + 1; ?></td>
                                            <td><?= $atl['kode_barang']; ?></td>
                                            <td><?= $atl['nup']; ?></td>
                                            <td><?= $atl['nama_barang']; ?></td>
                                            <td><?= $atl['kuantitas']; ?></td>
                                            <td hidden><?= $atl['perolehan']; ?></td>
                                            <td><?= $atl['no_sk']; ?></td>
                                            <td hidden><?= $atl['tanggal_sk']; ?></td>
                                            <td hidden><?= $atl['instansi_sk']; ?></td>
                                            <td hidden><?= $atl['sesuai']; ?></td>
                                            <td hidden><?= $atl['tidak_sesuai']; ?></td>
                                            <td hidden><?= $atl['pihak_lain']; ?></td>
                                            <td><?= $atl['keterangan']; ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-blue" style="white-space: nowrap;" onclick="atldetail(<?= $atl['id']; ?>)"><i class=" fa-solid fa-circle-info"></i>&nbsp; Detail</button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
