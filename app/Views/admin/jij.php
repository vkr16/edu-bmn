                    ...
                    <div class="card rounded-1 bg-light border-0" hidden>
                        ...
                        <div class="card-body table-responsive">
                            <table id="tabel-jij" class="table">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($jijdata as $key => $jij) {
                                    ?>
                                        <tr>
                                            <td><?= $key + 1; ?></td>
                                            <td><?= $jij['kode_barang']; ?></td>
                                            <td><?= $jij['nup']; ?></td>
                                            <td><?= $jij['nama_barang']; ?></td>
                                            <td><?= $jij['kuantitas']; ?></td>
                                            <td hidden><?= $jij['perolehan']; ?></td>
                                            <td><?= $jij['no_sk']; ?></td>
                                            <td hidden><?= $jij['tanggal_sk']; ?></td>
                                            <td hidden><?= $jij['instansi_sk']; ?></td>
                                            <td hidden><?= $jij['sesuai']; ?></td>
                                            <td hidden><?= $jij['tidak_sesuai']; ?></td>
                                            <td hidden><?= $jij['pihak_lain']; ?></td>
                                            <td><?= $jij['keterangan']; ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-blue" style="white-space: nowrap;" onclick="jijdetail(<?= $jij['id']; ?>)"><i class=" fa-solid fa-circle-info"></i>&nbsp; Detail</button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
