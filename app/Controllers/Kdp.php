...
class Kdp extends BaseController
{
    protected $session;
    protected $userModel;
    protected $kdpModel;
    ...
    {
        return redirect()->to(HOST_URL . '/kdp/data/tanah');
    }
    ...
    public function kdpupload()
    {
        ...
        return redirect()->to(HOST_URL . '/kdp/data/konstruksi-dalam-pengerjaan');
    }
